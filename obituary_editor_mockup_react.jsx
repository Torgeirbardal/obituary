      ...
      <div className="bg-white rounded shadow-lg w-3/4 max-w-4xl p-6 overflow-auto max-h-[90vh]">
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-6">
            ...
            <input className="w-full border p-2 rounded mt-1" value={form.avdoede.fornavn} onChange={(e) => handleAvdoedeField("fornavn", e.target.value)} />
            ...
            <input className="w-full border p-2 rounded mt-1" value={form.avdoede.etternavn} onChange={(e) => handleAvdoedeField("etternavn", e.target.value)} />
          ...
          <div className="col-span-6">
            ...
            <label className="text-sm">Seremonitype</label>
            <input
              className="w-full border p-2 rounded mt-1"
              placeholder="F.eks. Begravelse"
              value={form.seremoni.type}
              onChange={(e) => setForm({ ...form, seremoni: { ...form.seremoni, type: e.target.value } })}
            />
            ...
            <label className="text-sm mt-2">Kundenummer i CrossAD</label>
            <input className="w-full border p-2 rounded mt-1" value={form.kunde.kundenummer} onChange={(e) => setForm({ ...form, kunde: { ...form.kunde, kundenummer: e.target.value } })} />
        ...
        <div className="mt-4 flex justify-end gap-2">
          ...
          <button className="px-3 py-1 bg-slate-800 text-white rounded" onClick={() => onSave(form)}>
